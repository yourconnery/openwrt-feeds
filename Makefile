...
PKG_SOURCE_URL:=https://github.com/yourconnery/baresip
...
$(eval $(call BuildPlugin,speex_aec,Speex audio codec dsp,speex_aec,+PACKAGE_baresip-mod-speex_aec:libspeexdsp))
